...
- 内置三个主题：`喵喵` 使用 `images/miaomiao.png`，`水蓝蓝` 使用 `images/shuilanlan.png`，`火花` 使用 `images/huohua.png`。
...
4. 替换 `images/miaomiao.png`、`images/shuilanlan.png` 或 `images/huohua.png`：对应主题的页面背景图。
